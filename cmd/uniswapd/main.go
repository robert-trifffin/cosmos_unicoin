...
import (
	...
	"github.com/robert-trifffin/cosmos_unicoin/app"
...
func main() {
	...
	config.SetBech32PrefixForAccount("uniswap", "uniswappub")
	config.SetBech32PrefixForValidator("uniswapval", "uniswapvalpub")
	config.SetBech32PrefixForConsensusNode("uniswapcons", "uniswapconspub")
	config.Seal()
...
func newApp(logger log.Logger, db dbm.DB, traceStore io.Writer) abci.Application {
	return app.NewUniswapApp(logger, db, traceStore,
